package com.example.mycashbook.javaclass;
...
//         Cursor cashCursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + "ORDER_BY = id" ,  null);
//        SELECT SUM(Nominal) FROM CashFlow WHERE Status =\""+ status+"\""
